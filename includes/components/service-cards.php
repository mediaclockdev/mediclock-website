...
/* ============================================================
   * Service cards — shared component (service pages)
   ...
   a short description; optional closing call to action underneath.
     ...
     $service_cards_title (string)  heading, screen readers only   — default 'Our services'
...
<section class="section svc-cards band-<?= $service_cards_theme ?>" id="<?= $h($service_cards_id) ?>" aria-labelledby="<?= $h($service_cards_id) ?>-title">
    <div class="container">
        <h2 id="<?= $h($service_cards_id) ?>-title" class="visually-hidden"><?= $h($service_cards_title) ?></h2>
        <div class="svc-cards-wrap">
            <ul class="row row-cols-1 row-cols-md-2 row-cols-lg-3 list-unstyled mb-0 svc-cards-grid">
...
<?php endif; ?>
<?php unset($service_cards_items, $service_cards_title, $service_cards_id, $service_cards_theme, $service_cards_cta, $scItem); ?>
