...
<section class="svc-intro band-<?= $intro_theme ?>">
    <div class="container">
        ...
        <p class="svc-intro-text"><?php if ($inI === 0 && $intro_lead !== ''): ?><strong><?= $h($intro_lead) ?></strong> <?php endif; ?><?= $h($inPara) ?></p>
        <?php endforeach; ?>
    </div>
</section>
<?php endif; ?>
<?php unset($intro_text, $intro_theme, $intro_lead, $intro_title, $inI, $inPara); ?>
