<?php
/* ============================================================
   * SEO Packages — page content  (entry: /package.php)
   Meta, section order and copy for this page. Reusable blocks come
   from includes/components/; this page's one-off blocks (package
   table, process, results…) live in includes/sections/package/.
   ============================================================ */
return [
    'title'       => 'SEO Packages Australia | Basic, Standard, Pro & Premium | Media Clock',
    'description' => 'Compare Media Clock SEO packages for Australian businesses, including technical SEO, local SEO, content, off-page optimisation, social optimisation and reporting.',
    'css'         => 'package',
    'sections'    => [
        // * Hero
        [
            'type'     => 'hero',
            'title'    => 'SEO packages Australia: built around what your website actually needs.',
            'sub'      => 'Basic to Custom, built for Australian businesses.',
            'cta'      => 'Explore SEO Packages',
            'cta_href' => '#packages',
        ...
        [
            ...
            'lead'    => 'Most agencies hand you a report. As an Australian SEO agency that also builds websites, we can go and make the fixes ourselves — which is the bit that usually stalls.',
            'theme'   => 'light',
        ...
        ['type' => 'package/results'],
        ['type' => 'package/why'],
        ['type' => 'package/locations'],
        // * Testimonials
        [
            'type'    => 'testimonials',
            'eyebrow' => 'Client Feedback',
            'title'   => 'What our clients say',
            'lead'    => 'Three honest reviews beat a promise about page one by Friday. Where we can, these are the same clients featured in the results above.',
            'theme'   => 'dark',
        ],
        // * FAQ
        [
        ...
        [
            'type'      => 'contact',
            'title'     => 'Want to know which SEO package fits your website?',
            'lead'      => 'Tell us what you want to improve and we can recommend a starting point.',
            'note'      => 'No need to choose a package first.',
            'privacy'   => 'We prioritise confidentiality and protect the information shared with us.',
            'interests' => ['Free consultation', 'SEO Essentials', 'SEO Growth', 'SEO Performance', 'Custom SEO quote',
